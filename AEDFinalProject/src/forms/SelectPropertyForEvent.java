...
//    final DefaultComboBoxModel model = new DefaultComboBoxModel(labels);
    ...
    private void initComponents() {
        ...
        jTableProp.setBackground(new java.awt.Color(14, 44, 63));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!location.equals("--SELECT--") && type.equals("--SELECT--") && capacity.equals("--SELECT--")) {
            System.out.println(jComboBox1.getSelectedItem().toString());
        } else if (!type.equals("--SELECT--") && location.equals("--SELECT--") && capacity.equals("--SELECT--")) {
            System.out.println(jComboBox3.getSelectedItem().toString());
        } else if (!capacity.equals("--SELECT--") && type.equals("--SELECT--") && location.equals("--SELECT--")) {
            System.out.println(jComboBox2.getSelectedItem().toString());
        } else if (!location.equals("--SELECT--") && !type.equals("--SELECT--") && capacity.equals("--SELECT--")) {
            System.out.println(jComboBox1.getSelectedItem().toString() + ", " + jComboBox3.getSelectedItem().toString());
        } else if (!location.equals("--SELECT--") && !capacity.equals("--SELECT--") && type.equals("--SELECT--")) {
            System.out.println(jComboBox1.getSelectedItem().toString() + ", " + jComboBox2.getSelectedItem().toString());
        } else if (!type.equals("--SELECT--") && !capacity.equals("--SELECT--") && location.equals("--SELECT--")) {
            System.out.println(jComboBox2.getSelectedItem().toString() + ", " + jComboBox3.getSelectedItem().toString());
        } else if (!location.equals("--SELECT--") && !type.equals("--SELECT--") && !capacity.equals("--SELECT--")) {
