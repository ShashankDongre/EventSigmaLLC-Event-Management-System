...
public class AssignPropertyAp extends javax.swing.JPanel {
    ...
    public ArrayList<PropertyEnlist> propertyList() {
        ...
        try {
            ...
            while (rs.next()) {
                property = new PropertyEnlist(rs.getString("Property_id"), rs.getString("PropertyName"), rs.getString("Capacity"), rs.getString("Street"), rs.getString("City"), rs.getString("Status"), rs.getString("Property_owner"));
    ...
    private void initComponents() {
        ...
        jTableApprove1.setBackground(new java.awt.Color(54, 72, 79));
