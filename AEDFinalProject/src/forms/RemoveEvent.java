 ...
 */
public class RemoveEvent extends javax.swing.JPanel {
    ...
    public RemoveEvent(String fName) {
        initComponents();
        this.fName = fName;
        populateReviewTable();
    ...
    private void initComponents() {
        ...
        reviewTable.setBackground(new java.awt.Color(14, 44, 63));
    ...
    private void deleteEvent(String buttonName) {
        ...
        Events event = (Events) reviewTableModel.getValueAt(selectedRow, 1);
        ...
        try ( Connection conn = DbUtil.getConnection();  
            ...
            Logger.getLogger(RemoveEvent.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void populateReviewTable() {
        ...
        try ( Connection conn = DbUtil.getConnection();  PreparedStatement ps = conn.prepareStatement(IQueryMapper.SELECT_EVENTS)) {
            ...
            while (rs.next()) {
                Events e = new Events();
                e.setEventId(rs.getString(14));
                e.setEventName(rs.getString(4));
                e.setCity(rs.getString(2).substring(0, rs.getString(2).indexOf(',')));
                e.setState(rs.getString(2).substring(rs.getString(2).indexOf(',')+1, rs.getString(2).length()));;
                e.setCapacity(rs.getString(3));
                e.setStatus(rs.getString(13));
                e.setFromDate(rs.getString(7));
