...
public class ViewEventStatus extends javax.swing.JPanel {
    ...
    public ArrayList<Events> eventList() {
        ...
        try {
            ...
            while (rs.next()) {
                event = new Events();
                event.setEventId(rs.getString(14));
                event.setEventName(rs.getString(4));
                event.setEventDescription(rs.getString(5));
...
//        System.out.println(list);
    ...
    private void initComponents() {
        ...
        jTableStatus.setBackground(new java.awt.Color(14, 44, 63));
        jTableStatus.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTableStatus.setForeground(new java.awt.Color(242, 242, 242));
